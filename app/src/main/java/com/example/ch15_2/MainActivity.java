                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i=0; i<jsonArray.length(); i++){
                                ...
                                else if(wheather.equals("Mist")){
                                    Glide.with(MainActivity.this).load("https://www.aldautomotive.com.my/Portals/Malaysia/EasyDNNnews/2047/img-foggy-weather-960x.jpg").into(weatherBackground);
